...
final class Batches implements BatchesContract
{
    ...
    public function list(array $parameters = []): BatchListResponse
    {
        ...
        /** @var Response<array{object: string, data: array<int, array{id: string, object: string, endpoint: string, errors: array<int, string>, input_file_id: string, completion_window: string, status: string, output_file_id: ?string, error_file_id: ?string, created_at: int, in_progress_at: int, expires_at: int, finalizing_at: ?int, completed_at: ?int, failed_at: ?int, expired_at: ?int, cancelling_at: ?int, cancelled_at: ?int, request_counts: array<string, string>, metadata: array<string, string>}>, first_id: ?string, last_id: ?string, has_more: bool}> $response */
        $response = $this->transporter->requestObject($payload);
