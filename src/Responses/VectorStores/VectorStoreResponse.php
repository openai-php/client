...
final class VectorStoreResponse implements ResponseContract, ResponseHasMetaInformationContract
{
    ...
    public static function from(array $attributes, MetaInformation $meta): self
    {
        return new self(
            ...
            VectorStoreFileCountsResponse::from($attributes['file_counts']),
            $attributes['status'],
            empty($attributes['expires_after']) ? null : VectorStoreExpiresAfterResponse::from($attributes['expires_after']),
    ...
    public function toArray(): array
    {
        return [
            ...
            'expires_after' => $this->expiresAfter instanceof \OpenAI\Responses\VectorStores\VectorStoreExpiresAfterResponse ? $this->expiresAfter->toArray() : null,
