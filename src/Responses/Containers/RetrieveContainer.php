 ...
 *
 * @phpstan-type RetrieveContainerType array{id: string, object: 'container', created_at: int, status: string, expires_after: ExpiresAfter, last_active_at: int, name: string}
 *
